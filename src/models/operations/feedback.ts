...
export type FeedbackResponse = components.FeedbackResponse | errors.ErrorResponse;

/** @internal */
export const FeedbackResponse$inboundSchema: z.ZodType<FeedbackResponse, z.ZodTypeDef, unknown> =
    z.union([components.FeedbackResponse$inboundSchema, errors.ErrorResponse$inboundSchema]);
...
export const FeedbackResponse$outboundSchema: z.ZodType<
    ...
    z.ZodTypeDef,
    FeedbackResponse
> = z.union([components.FeedbackResponse$outboundSchema, errors.ErrorResponse$outboundSchema]);
