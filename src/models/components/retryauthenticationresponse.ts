...
export namespace RetryAuthenticationResponseStatus$ {
  ...
  export const outboundSchema =
    RetryAuthenticationResponseStatus$outboundSchema;
}
...
> = z.object({
  ...
  created_at: z.string().datetime({ offset: true }).transform(v => new Date(v))
    .optional(),
  next_retry_at: z.string().datetime({ offset: true }).transform(v =>
    new Date(v)
  ).optional(),
...
> = z.object({
  ...
  nextRetryAt: z.date().transform(v => v.toISOString()).optional(),
