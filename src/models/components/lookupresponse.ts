...
/** @internal */
export const LineType$inboundSchema: z.ZodNativeEnum<typeof LineType> = z.nativeEnum(LineType);

/** @internal */
export const LineType$outboundSchema: z.ZodNativeEnum<typeof LineType> = LineType$inboundSchema;
...
/** @internal */
export const LookupResponse$inboundSchema: z.ZodType<LookupResponse, z.ZodTypeDef, unknown> = z
    .object({
