 ...
 * Send a code
 */
export async function otpCreateAuthentication(
    client$: DingCore,
...
> {
    ...
    const parsed$ = schemas$.safeParse(
        input$,
        (value$) => components.CreateAuthenticationRequest$outboundSchema.optional().parse(value$),
    ...
    const path$ = pathToFunc("/authentication")();
